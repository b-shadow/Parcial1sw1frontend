export const environment = {
  ...
  firebaseVapidKey: 'BJj10YLXrCxtJ032Sxh4ovOiuEMa1cZYmLRxDJKItHEFSGGP4UwIZQhKubn6kXBUnDHEouj6goPYn9HapoKgAU',
  pushTokenRegisterPath: '/api/v1/notificaciones/device-token',
};
